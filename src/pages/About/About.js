        ...
        <div className="home_products_main mt-40">
          <div className="row">
            <div className="col-lg-6 col-md-6 col-12">
              <p className="body1">
                Hello, I'm Ravi Kumar Yadav. I am Software Developer. As a Software
                developer, I have in-depth knowledge of Web development and App
                Development. I have working experience of Web development. I
                have in-depth knowledge of React js, Mongo Db, HTML/CSS and javascript 
                and as well as React native for App development.
              </p>
            </div>
